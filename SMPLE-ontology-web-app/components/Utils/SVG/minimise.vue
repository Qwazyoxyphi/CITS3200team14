<template>
  <div @click="$emit('minimise')" class="box">
    <svg
      version="1.1"
      id="Capa_1"
      ...
      style="enable-background:new 0 0 402.995 402.996;"
      xml:space="preserve"
    >
      <g>
        <g>
          <g>
            <path
              d="M232.025,182.955h134.667c5.521,0,10-4.477,10-10v-19.024c0-5.523-4.479-10-10-10h-78.046L400.067,32.51
            ...
            />
            <path
              d="M114.351,143.931H36.305c-5.523,0-10,4.477-10,10v19.024c0,5.523,4.477,10,10,10h134.666c5.523,0,10-4.477,10-10V38.289
            ...
            />
            <path
              d="M232.025,374.707h19.023c5.523,0,10-4.477,10-10V286.66L372.47,398.082c3.905,3.904,10.238,3.904,14.145,0l13.452-13.453
            ...
            />
            <path
              d="M16.38,398.082c3.905,3.904,10.238,3.904,14.142,0L141.943,286.66v78.047c0,5.523,4.478,10,10,10h19.025
