<template>
  <div class="box">
    <svg
      ...
      x="0px"
      y="0px"
      viewBox="0 0 414.789 414.789"
      style="enable-background:new 0 0 414.789 414.789;"
      xml:space="preserve"
    >
      <g>
        <path
          style="fill:none;"
          d="M78.279,144.455v216.821h80.21V232.593c0-6.627,5.373-12,12-12h73.814c6.627,0,12,5.373,12,12v128.683
		h80.209v-216.82L207.395,56.083L78.279,144.455z"
        />
        <rect x="182.488" y="244.593" style="fill:#73D0F4;" width="49.814" height="116.683" />
        <polygon
          style="fill:#73D0F4;"
          points="302.067,91.796 336.512,115.373 336.512,57.883 302.067,57.883 	"
        />
        <path
          style="fill:#3D6889;"
          d="M409.566,165.374l-49.054-33.574V45.883c0-6.627-5.373-12-12-12h-58.445c-6.628,0-12,5.373-12,12
