<template>
  <div class="box">
    ...
    >
      <path
        style="fill:#303C42;"
        d="M466.208,88.458L380.875,3.125c-2-2-4.708-3.125-7.542-3.125H42.667C19.146,0,0,19.135,0,42.667v384
	...
	"
      ...
      <g>
        <path
          style="fill:#F2F2F2;"
          d="M106.667,21.333h234.667v128c0,11.76-9.563,21.333-21.333,21.333H128
      ...
      <path
        style="fill:#4FC3F7;"
        d="M448,426.667c0,11.76-9.563,21.333-21.333,21.333h-21.333V245.333
	...
	v-128h6.25L448,100.417V426.667z"
      ...
      <path
        style="fill:#303C42;"
        d="M266.667,149.333h42.667c5.896,0,10.667-4.771,10.667-10.667V53.333
	...
	C256,144.563,260.771,149.333,266.667,149.333z"
      ...
      <path
        ...
        d="M466.208,88.458L380.875,3.125c-2-2-4.708-3.125-7.542-3.125H42.667
